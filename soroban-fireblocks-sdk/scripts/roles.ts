/**
 * `npm run roles` — print a table of which roles are configured in the
 * current environment. Doesn't validate anything beyond presence of
...
const ROLES = [
  ...
  { name: "ONBOARDER", pkVar: "ONBOARDER_PUBLIC_KEY", vaultVar: "ONBOARDER_FIREBLOCKS_VAULT_ACCOUNT_ID" },
